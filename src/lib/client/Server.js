...
class Server extends Server_1.default {
    ...
    static getAllWithUserId(api, page = 1) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let res = yield api.call(`/application/servers?page=${page}`);
                resolve(res.data.map((value) => new Server(api, value.attributes, res.pagination)));
    ...
    suspend() {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.api.call(`/application/servers/${this.id}/suspend`, 'POST', null, true);
                resolve();
            }
            catch (error) {
                reject(error);
    ...
    unsuspend() {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.api.call(`/application/servers/${this.id}/unsuspend`, 'POST', null, true);
                resolve();
            }
            catch (error) {
                reject(error);
